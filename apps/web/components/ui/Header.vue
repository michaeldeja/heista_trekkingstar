<template>
    ...
    <MegaMenu :categories="categoryTree">
        <div class="max-w-screen-3xl px-3 md:px-6 lg:px-10 mx-auto bg-white ">
            <div>
                <!-- Logo und Suche zentriert -->
                <div class="flex items-center justify-between md:justify-center w-full gap-[15px] lg:gap-[30px]">
                    <!-- Logo -->
                    <div>
                        <NuxtLink :to="localePath(paths.home)">
                            <NuxtImg
                                ...
                                class="w-100 h-auto max-h-[60px] lg:max-h-[80px] lg:h-[80px] img-fluid py-2"
                                preload
                            />
                        </NuxtLink>
                    </div>
