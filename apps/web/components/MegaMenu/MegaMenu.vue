<template>
  <header ref="referenceRef" class="relative w-full h-full z-40 md:sticky md:shadow-md">
    <div
      class="flex justify-center items-center flex-wrap md:flex-center px-4 md:px-10 py-2 md:py-5 w-full h-full border-0 bg-white border-neutral-200 md:h-20 md:z-10"
