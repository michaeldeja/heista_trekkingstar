    ...
    <div class="max-w-screen-3xl mx-auto py-12">
      <div class="flex">
        ...
        <div class="w-3/4 p-6 overflow-x-auto">
          ...
          <p class="mb-4">
            Für allgemeine Verbraucherprobleme ist grundsätzlich die Allgemeine Verbraucherschlichtungsstelle des Zentrums für Schlichtung e. V. zuständig, welche Sie unter 
            <a href="https://www.verbraucher-schlichter.de" target="_blank" class="text-blue-500">https://www.verbraucher-schlichter.de</a> 
